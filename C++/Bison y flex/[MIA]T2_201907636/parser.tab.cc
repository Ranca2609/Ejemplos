...
#line 147 "parser.tab.cc"
  ...
  calculadora_parser::by_state::type_get () const YY_NOEXCEPT
  {
...
#line 451 "parser.tab.cc"
  ...
  void
  calculadora_parser::yypop_ (int n)
  {
    yystack_.pop (n);
  }
...
#line 719 "parser.tab.cc"
  ...
  case 7:
#line 57 "parser.yy"
                                 {printf("Comando exec ejecutado con exito\n");}
...
#undef YYCASE_
  ...
  const signed char calculadora_parser::yypact_ninf_ = -8;
  ...
  {
       1,    11,     0,     0,     2,     3,     4,     5,     6,     7,
      10,     0,     0,     0,     2,     3,     4,     5,     6,     7
  };
  ...
  {
  "\"eof\"", "error", "$undefined", "\"id\"", "\"reservada_rep\"",
  "\"reservada_path\"", "\"reservada_exec\"", "\"reservada_mkdisk\"",
  "\"ruta\"", "\"igual\"", "\"num\"", "$accept", "INICIO", "INSTRUCCIONES", YY_NULLPTR
  };
